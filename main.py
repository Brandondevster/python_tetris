...
bg = pygame.image.load('img/galaxybg2.jpg').convert()
game_bg = pygame.image.load('img/galaxybg.jpg').convert()

main_font = pygame.font.Font('font/Font.ttf', 65)
font = pygame.font.Font('font/Font.ttf', 45)

title_tetris = main_font.render('TETRIS', True, pygame.Color('darkorange'))
title_score = font.render('score:', True, pygame.Color('indigo'))
title_record = font.render('Record:', True, pygame.Color('indigo'))
...
while True:
    ...
    sc.blit(font.render(record, True, pygame.Color('yellow')), (550, 710))
    # game over
    for i in range(W):
        if field[0][i]:
